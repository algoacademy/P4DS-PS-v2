...
- `Ship.Mode`: Type of shipment with 4 levels ("First Class", "Same Day", "Second Class", "Standard Class") 
- `Customer.ID`: Id of customer.
- `Segment` : Customer's segment with 3 levels ("Consumer", "Corporate", "Home Office")
...
I. Hypothesis
H0: Sales = 228.61 USD (promotion does not affect number of sales)
H1: Sales > 228.61 USD (promotion does affect number of sales)
